...
class TransformerPureDetector(nn.Module):
            ...
            new_targets.append(
                {
                    ...
                    "languages": targets_per_image.languages
                }
            )
    ...
    def inference(
        ...
        for idx, (scores_img, ctrl_point_img, bd_img, lan_img, image_size) in enumerate(
                zip(scores, ctrl_point_coord, bd_points, languages, image_sizes)
        ):
