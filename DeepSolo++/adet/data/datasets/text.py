...
def register_text_instances(name, metadata, json_file, image_root, num_pts_cfg):
    ...
    DatasetCatalog.register(
        name, lambda: load_text_json(json_file, image_root, name, num_pts_cfg=num_pts_cfg)
    )
...
def load_text_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None, num_pts_cfg=25):
    """
